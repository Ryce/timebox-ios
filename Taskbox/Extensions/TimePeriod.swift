...
public extension TimePeriodProtocol {
    ...
    public var duration: TimeInterval {
        get {
            if let _duration = _duration {
                return _duration
            } else  if self.beginning != nil && self.end != nil {
...
open class TimePeriod: TimePeriodProtocol {
    ...
    public var _duration: TimeInterval?
    ...
    public init(beginning: Date?, end: Date?) {
        ...
        self.end = end
        if let beginning = beginning, let end = end {
            self._duration = abs(beginning.timeIntervalSince(end))
        } else {
            self._duration = nil
        }
    }
    ...
    public init(timeInterval: TimeInterval) {
        self.beginning = Date()
        self.end = self.beginning?.addingTimeInterval(timeInterval)
    }
